...
public class FoodListServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      Cookie[] cookies=request.getCookies();//나의 브라우저에 저장된 모든 쿠키 읽기
      if(cookies!=null)
      {
    	//최신 방문한걸 맨처음 나오게 하려고 역순으로 for문 돌림
      ...
      for(FoodVO vo:list)
      {
         ...
         //윈래 FoodDetailServlet이었는데 cookie에 response값 하나 더 주려고 Before페이지를 하나 더 많듬
      ...
      if(clist.size()!=0)
      {
    	  ...
    	  {
    		  out.write("<a href=FoodDetailServlet?fno="+vo.getFno()+">");
    		  out.write("<img src="+vo.getPoster()+" style=\"width:100px;height:100px;margin:10px 0px 0px 5px;\">");
    		  out.write("</a>");
    	  }
      }
      else
